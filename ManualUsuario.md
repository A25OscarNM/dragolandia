...
**Índice**   
1. [Creacion de las entidades de juego](#id1)
   1.1 [Creacion de un mago](#id11)
   1.2 [Creacion de un monstruo](#id12)
   1.3 [Creacion de un bosque](#id13)
   1.4 [Creacion de un dragon](#id14)
2. [Como jugar](#id2)


## Creacion de las entidades de juego<a name="id1"></a>


#### Creacion de un Mago<a name="id11"></a>
Este es el panel inicial que aparece al inciar la aplicacion, en este tendremos un formulario
con 3 campos para establecer el nombre, vida y nivel de magia del mago que queramos crear. Al crear el mago este obtendra 2 hechizos de forma aleatoria.

![manualMago](/imgs/manualMago.png)
...
![selecionBosque](/imgs/selecionBosque.png)

Ahora nos aparecera un nuevo panel donde podemos ver los datos inciales de todos los que
van a pelear en esta batalla, arriba a la derecha nos aparecera el turno del mago y abajo tendremos los botones para selecionar el ataque que queremos realizar, cuando todos los mago hayan atacado podremos ver que acciones pasaron.

![partida](/imgs/modoJugar.png)
